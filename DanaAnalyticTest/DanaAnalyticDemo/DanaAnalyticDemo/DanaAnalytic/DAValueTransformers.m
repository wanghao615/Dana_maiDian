...
@implementation DAPassThroughValueTransformer
...
@implementation DABOOLToNSNumberValueTransformer
...
@implementation DACATransform3DToNSDictionaryValueTransformer
...
@implementation DACGAffineTransformToNSDictionaryValueTransformer
...
@implementation DACGColorRefToNSStringValueTransformer
...
@implementation DACGPointToNSDictionaryValueTransformer
...
@implementation DACGRectToNSDictionaryValueTransformer
...
@implementation DACGSizeToNSDictionaryValueTransformer
...
@implementation DANSAttributedStringToNSDictionaryValueTransformer
...
- (id)transformedValue:(id)value {
    if ([value isKindOfClass:[NSAttributedString class]]) {
        ...
        if (data) {
            ...
            DAError(@"Failed to convert NSAttributedString to HTML: %@", error);
        }
    }
    ...
    if ([value isKindOfClass:[NSDictionary class]]) {
        ...
        if ([mimeType isEqualToString:@"text/html"] && dataString) {
            ...
            if (attributedString == nil) {
                DAError(@"Failed to convert HTML to NSAttributed string: %@", error);
            }
...
@implementation DANSNumberToCGFloatValueTransformer
