...
@implementation NSData (DA_Base64)
...
+ (NSData *)da_dataFromBase64String:(NSString *)aString {
    ...
    size_t outputLength;
    void *outputBuffer = DA_NewBase64Decode([data bytes], [data length], &outputLength);
...
- (NSString *)da_base64EncodedString {
    ...
    char *outputBuffer =
    DA_NewBase64Encode([self bytes], [self length], false, &outputLength);
...
@implementation NSString (DA_Encrypt)
